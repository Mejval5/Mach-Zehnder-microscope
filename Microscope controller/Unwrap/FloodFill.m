...
function [IM_unwrapped, rowref, colref, coords]=FloodFill(IM_phase, branch_cuts, IM_mask, coords)
...
if coordGet
fig99=figure(99);
imagesc(immultiply(IM_phase, ~branch_cuts)), colormap(gray), axis square, axis off, title('Phase image');
set(gca,'YDir','normal')
